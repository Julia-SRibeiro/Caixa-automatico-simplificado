...
int main() {
    ...
    printf("Digite o numero de cedulas de 200: ");
    scanf("%i", &c200);
    printf("Digite o numero de cedulas de 100: ");
    scanf("%i", &c100);
    printf("Digite o numero de cedulas de 50: ");
    scanf("%i", &c50);
    printf("Digite o numero de cedulas de 20: ");
    scanf("%i", &c20);
    printf("Digite o numero de cedulas de 10: ");
    scanf("%i", &c10);
    printf("Digite o numero de cedulas de 5: ");
    scanf("%i", &c5);
    printf("Digite o numero de cedulas de 2: ");
    scanf("%i", &c2);
